...
```{r example-4-3, fig.width=10, fig.height=7, dpi=300, out.width="100%", fig.align='center'}
...
```{r example-3-3, fig.width=10, fig.height=7, dpi=300, out.width="100%", fig.align='center'}
clc_raster1 |> 
  plot_clc()
```
